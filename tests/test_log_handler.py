...
class TestLogParser(unittest.TestCase):
    ...
    def test_parse_success(self):
        ...
        self.assertEqual(lp.stats.ignored_lines_static_resources, 177)
    ...
    def test_parse_success_cub(self):
        ...
        self.assertEqual(lp.stats.ignored_lines_bot, 10)
    ...
    def test_parse_success_dataverse(self):
        ...
        self.assertEqual(lp.stats.ignored_lines_static_resources, 1022)
        self.assertEqual(lp.stats.ignored_lines_bot, 18183)
        self.assertEqual(lp.stats.ignored_lines_invalid_method, 1098)
        self.assertEqual(lp.stats.ignored_lines_invalid_user_agent, 0)
        self.assertEqual(lp.stats.ignored_lines_invalid_client_name, 0)
        self.assertEqual(lp.stats.ignored_lines_invalid_client_version, 0)
        self.assertEqual(lp.stats.ignored_lines_invalid_country_code, 11567)
        self.assertEqual(lp.stats.ignored_lines_invalid_local_datetime, 0)
        self.assertEqual(lp.stats.ignored_lines_http_redirects, 39)
        self.assertEqual(lp.stats.ignored_lines_http_errors, 598)
...
class TestBunnynetLogParsing(unittest.TestCase):
    ...
    def test_parse_success_bunny(self):
        ...
        self.assertEqual(self.lp.stats.ignored_lines_static_resources, 39)
